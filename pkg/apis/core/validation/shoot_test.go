  ...
  namespace1: <node-selectors-labels>
	namespace2: <node-selectors-labels>`),
						...
						KubeControllerManager: &core.KubeControllerManagerConfig{
							NodeCIDRMaskSizeIPv4: pointer.Int32(22),
		...
		Context("Provider validation", func() {
			...
			Context("NodeCIDRMask validation", func() {
				...
				BeforeEach(func() {
					shoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = &defaultNodeCIDRMaskSize
		...
		Context("KubeControllerManager validation", func() {
			...
			It("should fail updating immutable fields", func() {
				shoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = pointer.Int32(24)

				newShoot := prepareShootForUpdate(shoot)
				newShoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = pointer.Int32(22)
			...
			It("should succeed not changing immutable fields", func() {
				...
				newShoot := prepareShootForUpdate(shoot)
				newShoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = pointer.Int32(24)
			...
			It("should fail when nodeCIDRMaskSize is out of upper boundary", func() {
				shoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = pointer.Int32(32)
			...
			It("should fail when nodeCIDRMaskSize is out of lower boundary", func() {
				shoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = pointer.Int32(0)
			...
			It("should succeed when nodeCIDRMaskSize is within boundaries", func() {
				shoot.Spec.Kubernetes.KubeControllerManager.NodeCIDRMaskSizeIPv4 = pointer.Int32(22)
